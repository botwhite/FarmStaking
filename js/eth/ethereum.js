...
let INFURA_URL = `https://polygon-rpc.com/`; //`https://data-seed-prebsc-1-s1.binance.org:8545/`;
...
getFirstBeeAirdropAmount(CONTRACT).then(data => {
	FIRST_soul_AIRDROP_AMOUNT = data.FIRST_soul_AIRDROP_AMOUNT;
...
function getGlobalStatistic(){
	...
	CONTRACT.totalsoulsBought().then(data => {
		...
		console.log("ERROR", "web3infura.totalsoulsBought", error);
	});
