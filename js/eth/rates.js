...
$('[name="modal-rate-init-button"]').click(function(){
    ...
    for(let i = 0; i < storage["rate"]['rating'].length; i++){
        rates_list +=   '  <tr>'+
                        ...
                        '      </td>'+
                        '      <td>'+
                        '          <span class="bee-home"><a class="about-bee" href="https://'+NETWORK_URL+'polygonscan.com/address/'+storage["rate"]['rating'][i].address+'" target="_blank">'+storage["rate"]['rating'][i].address+'</a></span>'+
                        '      </td>'+
                        '      <td>'+
