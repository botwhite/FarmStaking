            ...
            if(operations.length != 0){
                ...
                for(let i = operations.length-1; i >= 0; i--){
                    ...
                    op_list += '<tr>'+
                            ...
                            '   </td>'+
                            '   <td>'+
                            '       <span class="transaction">'+'<a class="about-soul" href="https://'+NETWORK_URL+'bscscan.com/tx/'+operations[i].transactionHash+'" target="_blank">'+operations[i].transactionHash+'</a></span>'+
                            '   </td>'+
                            '   <td>'+
                            '       <span class="summa summa-transaction">'+format_number(operations[i].amount, 4)+' token</span>'+
                            arrow +
                            '   </td>'+
                            '</tr>';
                }
